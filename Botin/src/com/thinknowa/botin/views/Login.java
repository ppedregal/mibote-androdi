...
import com.thinknowa.botin.util.SdkManager;
...
public class Login extends Activity implements LoaderCallbacks<Cursor> {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String email = (String) preferences.getAll().get("email");
		if (email!=null){
		...
		String password = (String)preferences.getAll().get("password");
		if (password!=null){
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			try {
				SdkManager.getSdk().login(mEmail, mPassword);
				return true;
			} catch (RuntimeException ex){
			}
			try {
				SdkManager.getSdk().register(mEmail, mPassword);
